...
7. Cap TECHNICAL barbell complexity: Olympic lifts (snatch, clean, jerk) and their complexes stay at controlled, submaximal, technique-focused loads. Rule 6 never applies to them — an Olympic lift is not a valid choice for the heavy main lift (heavy Olympic progressions are removed per rule 3).
8. Metric units only: kg, metres, calories. Convert any lbs loads to sensible rounded kg.
...
- Good (complete example of the right size, for a back squat + wall ball day):
  ...
  - "Empty bar (20kg): 8 back squats, then 5 reps @ 40kg, 5 reps @ 60kg"
...
- The session's MAIN pattern (the one trained heavy per rule 6) must be tagged Heavy. Secondary patterns are judged by their own prescribed effort: conditioning-weight work is usually Moderate, technique-focused Olympic lifts are Light
