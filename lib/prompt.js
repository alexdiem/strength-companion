...
- Sanity-check the list against rule 10: the loads should average out to Moderate with some variation. If every line reads Light (and the original wasn't a deliberate light day), the programming above is wrong — fix the block loading first, don't just relabel
