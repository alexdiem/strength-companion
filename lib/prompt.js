...
10. Balance session intensity: do NOT water every movement down to a light load. Across the adapted session's work blocks, loading must average out to Moderate, with deliberate variation — some movements lighter, some heavier (within the rule 7 cap). Anchor the session's main strength movement at a solidly Moderate or Heavy prescribed effort and let accessories or conditioning pieces sit lighter. A session where every trained pattern comes out Light is a failed adaptation unless the ORIGINAL WOD was explicitly a light/recovery day — if trimming for time or safety substitutions have pushed everything Light, raise the load or drop the reps on the main movement(s) to restore the intended stimulus. Olympic lifts are the one exception: they stay technique-light per rule 3, so bring the intensity through the other patterns that day.
